                    ...
                    <div className="w-full p-3 mt-4 bg-white rounded shadow flex flex-shrink-0">
                        ...
                        <div className="pl-3 w-full">
                            <div className="flex items-center justify-between w-full">
                                <p className="focus:outline-none text-sm leading-none"><span className="text-indigo-700">150 students</span> took your <span className="text-indigo-700">EDU221</span> test</p>
