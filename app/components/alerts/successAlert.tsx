export default function SuccessAlert(props: {content: string, text_size: any}){

    return(

        <>
        
            <div className={`flex bg-success rounded-lg p-4 mb-4 ${props.text_size} text-white`} role="alert">
                ...
                <div>
                    <span className="font-medium">Success</span> {props.content}
                </div>
            </div>
