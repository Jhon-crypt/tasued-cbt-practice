export default function ErrorAlert(props: {content: string}){

    return (

        <>
        
            <div className="flex bg-error rounded-lg p-4 mb-4 text-sm text-white" role="alert">
                ...
                <div>
                    <span className="font-medium">Error</span> {props.content}
                </div>
            </div>
