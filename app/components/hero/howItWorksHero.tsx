                                    ...
                                    <div className="flex flex-wrap -m-3">
                                        ...
                                        <div className="flex-1 p-3">
                                            <div className="md:max-w-xs pb-8">
                                                ...
                                                <h3 className="mb-2 text-xl text-white font-bold leading-normal">Practice Tests</h3>
                                                <p className="text-gray-300 font-medium leading-relaxed">It offers simulations in varieties of Tasued courses in form of tests and exams to help students improve their speed and accuracy</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex flex-wrap -m-3">
                                        ...
                                        <div className="flex-1 p-3">
                                            <div className="md:max-w-xs pb-8">
                                                ...
                                                <h3 className="mb-2 text-xl text-white font-bold leading-normal">Track Performance</h3>
                                                <p className="text-gray-300 font-medium leading-relaxed">Responsive feedbacks on students performances in practice tests/exams, This could help students focus their studying efforts where they need it the most</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex flex-wrap -m-3">
                                        ...
                                        <div className="flex-1 p-3">
                                            <div className="md:max-w-xs pb-8">
                                                ...
                                                <h3 className="mb-2 text-xl text-white font-bold leading-normal">Study Resources</h3>
                                                <p className="text-gray-300 font-medium leading-relaxed">(coming soon) Study resources, such as study guides are also included to help students prepare for exams and tests.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
